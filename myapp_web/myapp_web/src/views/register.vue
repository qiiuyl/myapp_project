<template>
    <div :style="Height" id="bg">
        <div id="header"> 
            <van-nav-bar right-text="登录" @click-right="onClickRight" left-arrow/>
        </div>
        <div class="img"></div>
        <div id="container"> 
           <div><span>昵称：</span><input ref="uname" v-model="uname" type="text" placeholder="请填写您的用户名"></div>
            <div><span>手机号：</span><input ref="phone" v-model="phone" type="text" placeholder="请填写您的手机号"></div>
            <div><span>密码：</span><input ref="upwd" v-model="upwd" type="text" placeholder="请填写您的密码"></div>
        </div>
        <div id="button">
